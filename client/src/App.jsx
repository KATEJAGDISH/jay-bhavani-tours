      ...
      <div className="container">
        ...
        <div className="fleet-tabs">
          ...
          <button
            type="button"
            className={
              selectedCategory === "SUV Plus"
                ? "fleet-tab active"
                : "fleet-tab"
            }
            onClick={() =>
              setSelectedCategory("SUV Plus")
            }
          >
            🚐 SUV Plus
          </button>
    ...
    >
      ...
      <div className="about-grid">
        ...
        <div className="about-box">
          ...
          <p>
            Jay Bhavani Tours and Travels is
            a customer-focused cab service
            for local rides, airport transfers,
            outstation trips and corporate travel.
          </p>
